...
classdef CDPRENV < rl.env.MATLABEnvironment
    ...
    methods              
        ...
        function [Observation,Reward,IsDone,LoggedSignals] = step(this,Action)
            ...
            [new_states,this.l0] = traj_tracking(joint_state,this.X,this.X_des,this.l0,this.Ts);
            ...
            model1.fail = 0;
            m1 = fourPRPR(model,model1);
            [this.kappa,this.mom] = m1.poseQuality(this.X,this.l0);
            ...
            Observation = [this.X(1:2);this.X(4:5);this.track_error(1:2);this.l0]; % 10 by 1 vector
        ...
        function InitialObservation = reset(this)
            ...
            if this.train == true
                ...
                this.P0 = [0.4*rand(1) + 0.2;0.4*rand(1) + 0.2];
                this.P1 = [0.4*rand(1) + 0.2;0.4*rand(1) + 0.2];
                this.P2 = [0.4*rand(1) + 0.2;0.4*rand(1) + 0.2];
            ...
            Observation = [this.X(1:2); this.X(4:5); 0;0; this.l0]; % 10 by 1 vector
