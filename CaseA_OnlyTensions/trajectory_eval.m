...
for i = 3:2:nw
    ...
    new_states =experience.Observation.ActualEndEffectorPosition_Velocity_PositionError_VelocityError.Data;
    new_states_ = squeeze(new_states);
    X = new_states_(1:8,:);
    %kappa = new_states_(9,:);
    joint_states = experience.Observation.ActualEndEffectorPosition_Velocity_PositionError_VelocityError.Data;
